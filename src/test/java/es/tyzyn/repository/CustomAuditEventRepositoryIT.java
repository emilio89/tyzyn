package es.tyzyn.repository;

import es.tyzyn.TyzynApp;

import es.tyzyn.config.Constants;
import es.tyzyn.config.audit.AuditEventConverter;
import es.tyzyn.domain.PersistentAuditEvent;
...
import static es.tyzyn.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = TyzynApp.class)
@Transactional
